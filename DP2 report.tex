...
\subsection{Throughput and Sending Images}
...
\begin{enumerate}
  \item The best cost path by taking the edge going to adjacent nodes j. 
...
Where the cost of path is defined by the following equation:
...
Node Number & Total Expectet Transmittion Cost [TETC] & Latest Message ID  \\[0.5ex] % inserts table
%heading
