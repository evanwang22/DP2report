...
\begin{enumerate}
  \item First try sending a contention window of image packets to the best path if its ECNB bit is 0 and the packet is not marked that it is being re-routed.
