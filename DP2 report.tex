...
\begin{figure}[ht!]
\centering
\includegraphics[width=4in]{"Simple Network".jpg}
\caption{\textbf{f1.txt} is the current version of the file}
\end{figure}


The network table must store LSAs issued from every node in the network. This
